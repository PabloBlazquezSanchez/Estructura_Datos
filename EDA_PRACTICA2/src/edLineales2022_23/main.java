...
public class main {
	...
	/**
	 * Este método es una serie de "cases-switch", en el que cada opción (1-4)
	 * representará una función que hará el programa. El caso default será un número
	 * no admitido y los carácteres no admitidos se tratan en el método
	 * filtrarescritura().
	 * 
	 * El menú se ejecutará en bucle, y este terminará con la opción 4, que
	 * corresponde a salir del programa.
	 * 
	...
	public static void mostrarMenu() {
		...
		do {
			...
			case 3:
				System.out
						.println("El beneficio total que se ha obtenido es un total de " + cartera.devolverbeneficio());
				break;
			case 4:
